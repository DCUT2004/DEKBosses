class MinionIceSkaarjFreezing extends IceSkaarjFreezing;
...
{
		return ( P.class == class'MinionIceSkaarjFreezing' || P.Class == class'IceQueen' || P.Class == Class'IceChildSkaarjPupae');
}
