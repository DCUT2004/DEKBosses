...
defaultproperties
{
	AmmunitionClass=Class'DEKBossMonsters208AC.IceNaliBossAmmo'
	DamageReductionMultiplier=0.500000
	XPReward=200
	MinionClass=Class'DEKBossMonsters208AC.MinionIceSlith'
	AdrenDripAmount=7
	ComboClass(0)=Class'DEKRPG208AC.ComboFreezeInv'
	bComboDamage=True
	...
	DamTypeRetaliationClass=Class'DEKBossMonsters208AC.DamTypeIceNaliRetaliation'
	...
	VeryHighMaterials(0)=Class'DEKRPG208AC.AbilityMaterialMoonlitStone'
	AChannel=255
	DeathAnim(0)="Dead"
	DeathAnim(1)="Dead2"
	DeathAnim(2)="Dead3"
