...
defaultproperties
{
	...
	XPReward=200
	MinionClass=Class'DEKBossMonsters208AD.MinionIceSkaarj'
	AdrenDripAmount=7
	ComboClass(0)=Class'DEKRPG208AD.ComboLifeDrainInv'
	ComboClass(1)=Class'DEKRPG208AD.ComboMisfortuneInv'
	bComboDamage=False
	ComboDamage=0
	...
	VeryHighMaterials(0)=Class'DEKRPG208AD.AbilityMaterialHourglass'
}
